...
var hljs = (function () {
  ...
  function inherit$1(original) {
    ...
    for (
      var _len = arguments.length,
        objects = new Array(_len > 1 ? _len - 1 : 0),
        _key = 1;
      _key < _len;
      _key++
    ) {
  ...
  var expandScopeName = function expandScopeName(name, _ref) {
    ...
    if (name.includes(".")) {
      ...
      return ["".concat(prefix).concat(pieces.shift())]
        .concat(
          _toConsumableArray(
            pieces.map(function (x, i) {
  ...
  var COMMENT = function COMMENT(begin, end) {
    ...
    var ENGLISH_WORD = either(
      ...
      "in",
      "it",
      "on", // note: this is not an exhaustive list of contractions, just popular ones
  ...
  */
  ...
  var warn = function warn(message) {
    ...
    (_console = console).log.apply(
      _console,
      ["WARN: ".concat(message)].concat(args)
    );
  };
  /**
  ...
  function compileLanguage(language) {
    ...
    */
    ...
    function compileMode(mode, parent) {
      ...
      mode.contains = (_ref6 = []).concat.apply(
        _ref6,
        _toConsumableArray(
  ...
  var HLJS = function HLJS(hljs) {
    ...
    function _highlight(
      ...
      function processKeywords() {
        ...
        while (match) {
          ...
          var word = language.case_insensitive
            ? match[0].toLowerCase()
            : match[0];
      ...
      function doBeginMatch(match) {
        ...
        for (
          var _i2 = 0, _beforeCallbacks = beforeCallbacks;
          _i2 < _beforeCallbacks.length;
          _i2++
        ) {
      ...
      function processLexeme(textBeforeMatch, match) {
        ...
        if (
          ...
          if (!SAFE_MODE) {
            /** @type {AnnotatedError} */
            var err = new Error(
              "0 width match regex (".concat(languageName, ")")
            );
    ...
    */
    ...
    function highlightElement(element) {
      ...
      if (element.children.length > 0) {
        ...
        if (options.throwUnescapedHTML) {
          var err = new HTMLInjectionError(
    ...
    function unregisterLanguage(languageName) {
      ...
      for (
        var _i3 = 0, _Object$keys = Object.keys(aliases);
